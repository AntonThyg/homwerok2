package oldProjects.ForLoops; /****************************************
 * Sample solution for Activity 2.4.1
 ***************************************/
...
public class StudentChooser
{
     ...
     *
     * @param studentNumber Precondition: studentNumber is an int between 1 and 7 inclusive
     * @return the student name corresponding to studentNumber
     */
    public static String getStudent(int studentNumber)
    {
        String students = "Alicia Carol Jason Karine Mark Sheila Wyatt";
